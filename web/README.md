...
2. Run `supabase/migrations/0001_workspace_foundation.sql`, then `supabase/migrations/0002_auth_bootstrap.sql`, in the SQL editor or through the Supabase CLI.
